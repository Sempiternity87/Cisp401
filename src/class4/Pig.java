...
class Game
  ...
  *****************************************************************************/
  ...
  public static final int    WIN_CONDITION = 100;
  ...
  * checkForWinner */
  /**
  * Checks if the win condition has been met by any player.
  * 
  * @param  true=Win condition has been met.
  *****************************************************************************/
  public boolean checkForWinner()
    {
    for (Player p : mPlayers)
      if (p.score >= WIN_CONDITION)
        return true;
  ...
  * rollDice */
  /**
  * Randomly picks a number between 1 and 6. A "1" will wipe the current total
  * and end the turn. Any other number will be added to the current total.
  * 
  * @param  true=Win condition has been met.
  *****************************************************************************/
  ...
  *****************************************************************************/
  public boolean startTurn()
    ...
    if (getCurrentPlayer().human)
      ...
      roll = getCurrentPlayer().score + mTurnScore < WIN_CONDITION;
      if (mTurnScore >= 10)
        roll = false;
      }
...
class Player
  ...
  * @param  human  true=The player is human.
  *****************************************************************************/
